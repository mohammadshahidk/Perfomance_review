    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(1, 'Admin'), (2, 'Employee')], default=accounts.constants.UserRole['Admin'])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('projectuser_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('emp_id', models.CharField(blank=True, default='', max_length=200, null=True, verbose_name="employee's id")),
                ('designation', models.CharField(blank=True, default='', max_length=200, null=True)),
                ('date_of_join', models.DateTimeField(blank=True, default=None, null=True)),
            ],
            options={
